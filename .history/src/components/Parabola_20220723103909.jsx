...
import animateCSS from './../../.history/src/utils/animateCSS_20220723103550';
const run = (startRef, endRef, parabolaRef, runningRef) => {
  ...
  if (!runningRef.current) {
    ...
    flyOuterNode.ontransitionend = () => {
      ...
      endRef.current.classList.add('animate__animated', 'animate__pulse')
      animateCSS(endRef.current, animate__pulse)
    }
  }
}

const ParabolaBall = forwardRef(
  (
